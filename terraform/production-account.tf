module "production_account" { # Module call names must be unique
  ...
  control_tower_parameters = {
    ...
    ManagedOrganizationalUnit = "Production (ou-v919-xyg1342j)"              # example: "Template"
  ...
  change_management_parameters = {
    ...
    change_reason = "Provisioning new Production account"
  }
  ...
  account_customizations_name = "accounts/production-account" # example: accounts/template-account
}
