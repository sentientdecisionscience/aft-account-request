module "shared_services_account" { # Module call names must be unique
  ...
  control_tower_parameters = {
    AccountEmail              = "aws.shared-services@sentientdecisionscience.com" # example: aws.account+template@company.com
    AccountName               = "Shared Services"                                 # example: "Template"
    ManagedOrganizationalUnit = "Infrastructure"                                  # example: "Template"
    SSOUserEmail              = "aws.shared-services@sentientdecisionscience.com" # example: aws.account+template@company.com
    SSOUserFirstName          = "Shared Services"                                 # example: Template
  ...
  change_management_parameters = {
    ...
    change_reason = "Provisioning new Shared Services account"
  }
  ...
  account_customizations_name = "accounts/shared-services-account" # example: accounts/template-account
}
