module "log_archive_account" {
  ...
  control_tower_parameters = {
    AccountEmail              = "aws.log-archive@sentientdecisionscience.com"
    AccountName               = "Log Archive"
    ManagedOrganizationalUnit = "Security"
    SSOUserEmail              = "aws.log-archive@sentientdecisionscience.com"
    SSOUserFirstName          = "Log Archive"
  ...
  change_management_parameters = {
    ...
    change_reason = "Import Log Archive Account into AFT"
  }
  ...
  account_customizations_name = "accounts/log-archive-account"
}
